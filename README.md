...
- **What I'm working on now:** Building the backend for a [stock tracker application](https://github.com/aemann2/stock-tracker-backend). It's my first time implementing registration and login on my own, and I'm learning a lot about authentication. Next month I will be building out the [frontend](https://github.com/aemann2/stock-tracker-frontend). I'm planning on migrating the backend to a new stack: Next.js, Typescript, Prisma, Postgres, and GraphQL.
