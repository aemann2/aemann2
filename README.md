...
- **What I'm currently learning:** PERN stack (which is Postgres instead of MongoDB). I've also started working with React Native and am creating my first NextJS app from scratch!
