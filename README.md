...
- **What I'm working on now:** Building out the backend for a [stock tracker application](https://github.com/aemann2/stock-tracker-backend). It's my first time implementing registration and login on my own, and I'm learning a lot about authentication.
